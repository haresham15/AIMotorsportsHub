  ...
  return (
    <div className="min-h-screen bg-[var(--graphite-950)] text-[var(--text-primary)] flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-[var(--sp-5)] text-center relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] border-[1px] border-[var(--graphite-700)] rounded-full opacity-30"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] border-[1px] border-[var(--graphite-700)] rounded-full opacity-50"></div>
        ...
        <div className="relative z-10">
          ...
          <h1 className="font-[family-name:var(--font-disp)] text-[clamp(32px,5vw,48px)] font-bold uppercase mt-4 mb-2 tracking-[-0.01em]">
            Off Track
          </h1>
