...
const NASCAR_SERIES = [
  {
    ...
    shortName: 'CUP',
    description: 'The premier stock car racing series: 36 races, a 16-driver playoff, and the crown jewel Daytona 500.',
    icon: <Trophy size={28} />,
    color: '#f59e0b',
    stats: {
      races: 36,
  ...
  },
  {
    ...
    shortName: 'TRKS',
    description: 'Short-track racing with full-size trucks and one of the most unpredictable grids in NASCAR.',
    icon: <Truck size={28} />,
    color: '#10b981',
    stats: {
      races: 23,
        ...
        <div className="max-w-[1280px] mx-auto flex justify-between items-center h-[68px]">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <Flag size={18} className="text-[var(--amber)]" />
      ...
      <main className="max-w-[1280px] mx-auto px-6 pt-12 pb-20">
        ...
        <div className="animate-fade-in-up delay-300 mt-8 glass rounded-[var(--radius-xl)] p-6 flex items-center gap-4">
          ...
          <p className="text-[13px] text-[var(--text-secondary)] m-0">
            NASCAR&apos;s Cloudflare CDN updates during live sessions. Standings, pit stops, and flag data are pulled from timing and scoring when the selected series is active.
          </p>
        </div>
      </main>
    </div>
