...
export default function ModelPerformanceCharts({ metrics }: { metrics: OutcomeMetrics }) {
  ...
  return <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
    <section className="card glass rounded-[var(--radius-xl)] p-6">
      <h2 className="text-xl font-bold mb-1">Calibration curve</h2><p className="text-xs text-[var(--text-muted)] mb-5">Predicted podium probability versus observed frequency.</p>
    ...
    <section className="card glass rounded-[var(--radius-xl)] p-6">
      <h2 className="text-xl font-bold mb-1">Feature importance</h2><p className="text-xs text-[var(--text-muted)] mb-5">Relative contribution to the trained outcome model.</p>
